...
{
    digitalWrite(*(digitPinsPtr + digitValuePrevious), HIGH);
      ...
      break;
		...
		if (enableZB)
		{
			if (digitValueCurrent == 0)
				digitalWrite(*digitPinsPtr, LOW);
			else if (digitValueCurrent == 1)
			{
				if (!((*(digitsPtr + 3) == 0) && (*(digitsPtr + 2) == 0) && (*(digitsPtr + 1) == 0)))
				digitalWrite(*(digitPinsPtr + 1), LOW);
			}
			else if (digitValueCurrent == 2)
			{
				if (!((*(digitsPtr + 3) == 0) && (*(digitsPtr + 2) == 0)))
					digitalWrite(*(digitPinsPtr + 2), LOW);
			}
			else if (digitValueCurrent == 3)
			{
				if (*(digitsPtr + 3) != 0)
					digitalWrite(*(digitPinsPtr + 3), LOW);
			}
		}
		else
			digitalWrite(*(digitPinsPtr + digitValueCurrent), LOW);

...
//    }
    ...
    boolean success = upload(appletPath, foundName, programmingType);
    ...
    try {
	  ...
	  if (sizeSections!=null && sizeSections.equals("all")) {
          ...
          System.out.println(I18n
		                     ...
		                     size, maxTextSize,(text+data),(data+bss), size * 100 / maxTextSize));
      }
  ...
  protected boolean upload(String buildPath, String suggestedClassName, int programmingType) throws Exception {
    ...
    do {
      ...
      try {
        success = uploader.uploadUsingPreferences(getFolder(), buildPath, suggestedClassName, programmingType, warningsAccumulator);
      } finally {
